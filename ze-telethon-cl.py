...
async def handler(event):
    data = event.data.decode('utf-8')
    if data == 'ze':
        await bot.send_message(OWNER_ID, f"""**∘ بوت العقرب لتجميع النقاط واوامر اخرى 

∘ مطور ومبرمج البوت عبد القوي - @c1me_9

∘ بوت العقرب- من قبل مطورعبدالقوي**""")
...
async def start(event):
    ...
    if sender.id == DEVELOPER_ID:
        ...
        [Button.inline('رشق مشاهدات ⟐', 'akbo')],
         ...
         [Button.inline('༺ العقرب BOT ༻', 'button0')]
        ]
